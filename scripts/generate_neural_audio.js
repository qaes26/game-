...
const staticAudios = [
  ...
  // Hub Sections & Banners
  { category: 'hub', id: 'hub_banner_main', text: 'مَرْحَبًا يَا بَطَل! أَنَا لُومِي.. اخْتَرْ طَرِيقَ المَرَاحِلِ لِتَتَدَرَّبَ، أَوْ مَرْصَدَ الحُرُوفِ لِتَسْتَكْشِف، أَوْ مُخْتَبَرَ الذَّكَاءِ الاصْطِنَاعِيِّ لِتُقَيِّمَ نُطْقَك!' },
  { category: 'hub', id: 'hub_stages', text: 'طَرِيقُ المَرَاحِلِ السِّحْرِيّ.. اخْتَرْ حَرْفَكَ لِتَبْدَأَ المَرَاحِلَ الثَّمَانِيَة!' },
  { category: 'hub', id: 'hub_ai_lab', text: 'مُخْتَبَرُ النُّطْقِ بِالذَّكَاءِ الاصْطِنَاعِيّ.. انْطِقِ الكَلِمَةَ لِيُقَيِّمَكَ الذَّكَاءُ الاصْطِنَاعِيُّ فَوْرًا!' },
  { category: 'hub', id: 'hub_letters', text: 'مَرْصَدُ الحُرُوفِ الكَامِلَة.. ثَمَانِيَةٌ وَعِشْرُونَ حَرْفًا عَرَبِيًّا!' },
  { category: 'hub', id: 'hub_worlds', text: 'العَوَالِمُ الثَّلاثَةُ السَّاحِرَة.. وَادِي الحُرُوفِ وَغَابَةُ المَقَاطِعِ وَقَرْيَةُ الكَلِمَات!' },
  { category: 'hub', id: 'hub_games', text: 'قَلْعَةُ الأَلْعَابِ الثَّلاث.. أَلْعَابٌ مُمْتِعَةٌ لِصَيْدِ الحُرُوفِ وَالمَقَاطِعِ وَالكَلِمَات!' },
